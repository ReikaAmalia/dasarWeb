...
<head>
    ...
    <!-- Bootstrap -->
    <!-- <link rel="stylesheet" href="https://cdnjs.cloudfare.com/ajax/libs/twitter-bootstrap/4.1.3/css/bootstrap.css"> -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@4.3.1/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Font Awesome -->
    <link 
    href="https://use.fontawesome.com/releases/v5.7.2/css/all.css" 
    rel="stylesheet" 
    integrity="sha384-fnmOCqbTlWlIj8LyTjo7mOustjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr" 
...
<body>
    ...
    <div class="container">
        ...
        <form class="form-data" method="POST" id="form-data">
            <div class="row">
                <div class="col-sm-9">
